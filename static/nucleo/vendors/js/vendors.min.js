...
function (e, t) {
  ...
  class Re extends z {
    ...
    _setListeners() {
      ...
      }, q.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this._config.selector ? this._config = {
        ...this._config,
        trigger: "manual",
        selector: ""
      } : this._fixTitle()
    ...
    var k = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
      ...
      A = function (t) {
        function o(e) {
          ...
          return i(this, o), t = a(this, l(o).call(this)), k && d.call(s(t)), n = ["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "utils"], r = e, c = s(t), n.forEach((function (e) {
            r[e] && (c[e] = r[e])
